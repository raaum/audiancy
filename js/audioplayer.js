  ...
  */
  $jsonPlayList = [{
    "0": {
      ...
      "source": "audio/Southern Nights.mp3",
      "type": "audio/mp3",
      "album": "Southern Nights",
      "artist": "Glen Campbell",
      "poster": "audio/images/campbell.jpg"
    },
    "1": {
      "title ": "A Fifth of Beethoven",
      "source": "audio/A Fifth of Beethoven.mp3",
      "type": "audio/mp3",
      "album": "Saturday Night Fever Soundtrack",
      "artist": "Walter Murphy",
      "poster": "audio/images/snf.jpg"
    },
    "2": {
      "title ": "Ain't No Sunshine",
      "source": "audio/Aint No Sunshine.mp3",
      "type": "audio/mp3",
      "album": "Just as I Am",
      "artist": "Bill Withers",
      "poster": "audio/images/withers.jpg"
    },
    "3": {
      "title ": "Tempted",
      "source": "audio/Tempted.mp3",
      "type": "audio/mp3",
      "album": "East Side Story",
      "artist": "Squeeze",
      "poster": "audio/images/squeeze.jpg"
    },
    "4": {
      "title ": "Raspberry Beret",
      "source": "audio/Raspberry Beret.mp3",
      "type": "audio/mp3",
      "album": "Around the World in a Day",
      "artist": "Prince, The Revolution",
      "poster": "audio/images/prince.jpg"
    },
    "5": {
      "title ": "ABC",
      "source": "audio/abc.mp3",
      "type": "audio/mp3",
      "album": "ABC",
      "artist": "The Jackson Five",
      "poster": "audio/images/jackson5.jpg"
    }
  }];
  ...
  */
  ...
  function playAudio() {
    ...
    if (audioElement.readyState === 4) {
      ...
      if (!sourceAudio[trackindex]) {
        addAudioSource(trackindex);
      }
